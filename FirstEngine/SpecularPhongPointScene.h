...
public:
	...
	struct Wall {
		std::shared_ptr<TextureClass>	pTex;
		IndexedTriangleList				model;
		DirectX::XMFLOAT4X4				world;
	};

	SpecularPhongPointScene(const EngineOptions& options, std::shared_ptr<TextureClass> sysT, std::shared_ptr<TextureClass> wallT);
